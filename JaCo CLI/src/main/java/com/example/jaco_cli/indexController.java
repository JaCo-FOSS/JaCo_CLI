...
public class indexController implements Initializable {
    ...
    public void getData(ActionEvent event)throws Exception{
        ...
        StringData.setText(dataFetcher.fetcher(Country));
